...
function myMap() {                            
    ...
    for(let i in dati) {
        ...
        var string =
            '<div id="nuvola">' + 
            '<div id="nome_search">' + '<h1>' + dati[i]["nome"] + '</h1>' + '</div>' +
            '<div id="indirizzo">' + dati[i]['indirizzo'] + '</div>' +
            ...
            '<div id="forum_search">' + '<a href="messages.php?var=' + dati[i]['nome'] + '">' + 'forum evento</a>' + '</div>'+
            '</div>';
